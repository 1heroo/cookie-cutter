...
# protfolio_again/
APPS_DIR = ROOT_DIR / "protfolio_again"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "protfolio_again.contrib.sites.migrations"}
...
SOCIAL_AUTH_GITHUB_KEY = 'c04303abb91d897ec7f9'
SOCIAL_AUTH_GITHUB_SECRET = 'b2a36424ca999f95be4a41e9bbdb059b59538bf1'
OAUTH_CALLBACK_URL = "http://localhost:8000/oauth/complete/github"
...
TEMPLATES = [
    {
        ...
        "DIRS": [str(APPS_DIR / "templates"), 'my_user/templates', 'templates'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
ADMINS = [("""Adi""", "iswearican_1@outlook.com")]
